...
const UserDetails = () => {
  ...
  console.log("the data received is ", { name, email, id });

  return (
    <View style={style.container}>
      <Text style={style.crudText}>
        CRUD APP
      </Text>
      <View style={{ marginLeft: 30, marginVertical: 20 }}>
        <Text style={{ fontSize: 30, fontWeight: "bold" }}>EDIT USERS</Text>
...
const style = StyleSheet.create({
  ...
  crudText:{ fontSize: 20, alignSelf: "center", marginTop: 70 }
});
